...
@section('konten')
    <div class="container card">
        ...
        <form action="{{ route('perbaikan.store') }}" method="POST" class="font font-weight-bold"
            ...
            <input type="text" id="id_plg" name="id_plg" class="form-control" readonly>

            <label for="alamat_plg">Alamat</label>
            <input type="text" id="alamat_plg" name="alamat_plg" class="form-control" readonly>

            <label for="no_telepon_plg">No Telpon</label>
            <input type="text" id="no_telepon_plg" name="no_telepon_plg" class="form-control" readonly>

            <label for="paket_plg">Paket</label>
            <input type="text" id="paket_plg" name="paket_plg" class="form-control" readonly>

            <label for="odp">ODP</label>
            <input type="text" id="odp" name="odp" class="form-control">
