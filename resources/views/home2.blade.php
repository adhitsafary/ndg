...
<head>
    ...
    <title>Net Digital Group Digital</title>
</head>
...
<body>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                data-toggle="dropdown" aria-expanded="false">Promo </a>
                ...
                <div class="padding-jumbo">
                    <div class="row">
                        <div class="col-lg-6 align-self-center">
                            ...
                            <p class="lead">Net Digital Group Digital memberikanmu paket internet termurah dengan
                                pelayanan
                                Terbaik.</p>
                            <div class="btn-jumbo">
                                <a href="#" type="button" class="btn tombol">Daftar</a>
                                <a href="#" type="button" class="btn tombol-transparan"><i
    ...
    <div class="card m-5">
        <div class="row text-center justify-content-center mt-5 mb-5">
            <div class="col-lg-5">
                <h4 class="title">Rekomendasi Paket Untukmu</h4>
            </div>
        </div>
    </div>
        ...
        <div class="container flex-container mt-5">
            <div class="row">
                <div class="col-lg-7 pb-5">
                    <h4 class="title">Mengapa Harus Beralih ke Net Digital Group Digital?</h4>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 align-self-center">
                ...
                <div class="col-lg-6">
                    <p class="info">Net Digital Group Digital merupakan provider masa kini yang membuatmu semakin
                        maju.
                        Sekarang
                        kamu dapat memasang
                        provider
                        dirumahmu sendiri dengan hanya Rp 165.000 saja! Net Digital Group Digital selalu mengedepankan
                        kualitas
                        dengan harga paling
            ...
            <div class="row">
                <div class="card-about">
                    ...
                    <div class="card-featured text-lg-center">
                        ...
                        <h4>Paling Murah</h4>
                        <p>Net Digital Group Digital memberikanmu harga termurah dibandingkan provider lainnya</p>
                    </div>
                    <div class="card-featured text-lg-center">
                        <div class="rectangle text-center">
                        ...
                        <h4>CS 24 Jam</h4>
                        <p>Hubungi Net Digital Group Digital kapan saja, Customer Service kami siap melayani 24 jam</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="konsul">
        <div class="container flex-container">
            <div class="row">
                <div class="col-lg-6 align-self-center ">
                    <h4>Bingung Memilih Paketmu?</h4>
                    <p>Tenang, kamu dapat menghubungi Mister Net untuk berkonsultasi mengenai paket yang paling
                        cocok dengan
                        kamu.
    ...
    <footer>
        <div class="container flex-container">
            <div class="row">
                <div class="col-lg-6">
                    <h4>Area Cakupan Net Digital Group Digital</h4>
                ...
                <div class="col-lg-3">
                    <h4>Kontak Kami</h4>
                    <p>Untuk berlangganan produk Net Digital Group Digital</p>
        ...
        <div class="row icon-awesome justify-content-center">
            <a href="https://www.facebook.com/sandro.manullang.90" class=""><i
                    class="fab fa-facebook fa-3x mr-3"></a></i>
            <a href="https://www.linkedin.com/in/sandro-hamonangan-25b0231b3/" class=""><i
                    class="fab fa-linkedin fa-3x mr-3 "></a></i>
            <a href="https://www.instagram.com/sandroomanulang/" class=""><i
                    class="fab fa-instagram fa-3x mr-3 "></a></i>
