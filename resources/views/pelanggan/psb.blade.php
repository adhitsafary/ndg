                ...
                <table class="table table-bordered table-responsive"
                    ...
                    <thead style="background-color: rgb(233, 0, 0); color: white; text-align: center;">
                        <tr class="font-weight-bold">
                            ...
                            <th style="width: 1%; padding: 1px;">Aktifasi</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        @forelse ($pelanggan as $no => $item)
                            <tr class="">
                                ...
                                <td>
                                    <a href="{{ route('pelanggan.ubahStatusOn', $item->id) }}"
                                        class="btn btn-success btn-sm" style="font-size: 12px; padding: 4px 8px;"
                                        onclick="return confirm('Apakah {{ $item->nama_plg }} Akan di Non Aktifkan?')">Aktifkan</a>
                                </td>
                            </tr>
                        @empty
                            <tr>
