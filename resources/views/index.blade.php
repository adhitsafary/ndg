...
@section('konten')
    ...
    @endforelse
            ...
            <div class="col-xl-4 col-lg-5 mt-2 ">
                <div class="card">
                    <div class="card-header bg-primary d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-light" style="font-size: 14px;"> Pemberitahuan</h6>
                        <a class="m-0 float-right btn btn-danger btn-sm" href="/pemberitahuan">Lihat semua <i
                                class="fas fa-chevron-right"></i></a>
                    </div>
                    <div>
                        <table class="table table-bordered table-sm">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 10%; font-size: 12px;">Pesan</th>
                                    <th style="width: 10%; font-size: 12px;">Tanggal</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($pemberitahuan as $item)
                                    <tr>
                                        ...
                                        <td style="font-size: 12px;">{{ $item->pesan }}</td>
                ...
                <div class="card">
                    <div class="card-header bg-primary d-flex flex-row align-items-center justify-content-between p-2">
                        <h6 class="ml-2 font-weight-bold text-light" style="font-size: 14px;">
                            Pemasangan Bulan Ini (Total: {{ $total_pemasangan }})
                        </h6>
                    ...
                    <div>
                        <table class="table table-bordered table-sm">
                            <thead class="text-center">
                                <tr>
                                    <th style="width: 10%; font-size: 12px;">No</th>
                                    <th style="width: 30%; font-size: 12px;">Nama</th>
                                    <th style="width: 40%; font-size: 12px;">Alamat</th>
                                    <th style="width: 20%; font-size: 12px;">Tanggal</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($rekap_pemasangan_limited as $item)
                                    <tr>
                                        ...
                                        <td class="text-center" style="font-size: 12px;">{{ $item->tgl_aktivasi }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center" style="font-size: 12px;">Tidak ada
            ...
            <div class="col-xl-4 col-lg-5 mt-2">
                <div class="card">
                    <div class="card-header bg-primary d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-light" style="font-size: 14px;"> Perbaikan Hari Ini (Total:
                            {{ $total_perbaikan }})
                        </h6>
                        ...
                        <table class="table table-bordered table-sm">
                            <thead>
                                <tr>
                                    <th style="width: 10%; font-size: 12px;">No</th>
                                    <th style="width: 10%; font-size: 12px;">Nama</th>
                                    <th style="width: 10%; font-size: 12px;">Alamat</th>
                                    <th style="width: 10%; font-size: 12px;">Tanggal</th>
                                </tr>
                            </thead>
                            <tbody>
                                @forelse($perbaikan_limited as $item)
                                    <tr>
                                        <td class="text-center" style="font-size: 12px;">{{ $loop->iteration }}</td>
                                        <td style="font-size: 12px;">{{ $item->nama_plg }}</td>
                                        <td style="font-size: 12px;">{{ $item->alamat_plg }}</td>
                                        <td style="font-size: 12px;">{{ $item->created_at }}</td>
                                    </tr>
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">Tidak ada pemasangan bulan ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div class="col-xl-4 col-lg-5 mt-2">
                <div class="card">
                    <div class="card-header bg-primary d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-light" style="font-size: 14px;"> Pengeluaran Hari Ini :
                            {{ number_format($total_pengeluaran, 0, ',', '.') }}

                        </h6>
                        <a class="m-0 float-right btn btn-danger btn-sm" href="/pengeluaran/">Lihat semua <i
                                class="fas fa-chevron-right"></i></a>
                    </div>
                    <div>
                        <table class="table table-bordered table-sm">
                            <thead>
                                <tr>
                                    <th style="width: 10%; font-size: 12px;">No</th>
                                    <th style="width: 10%; font-size: 12px;">Keterangan</th>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">Tidak ada Pengeluaran hari ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div class="col-xl-4 col-lg-5 mt-2">
                <div class="card">
                    <div class="card-header bg-primary d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-light" style="font-size: 14px;"> Pemasukan Hari Ini :
                            {{ number_format($total_pemasukan, 0, ',', '.') }}

                        </h6>
                        <a class="m-0 float-right btn btn-danger btn-sm" href="/pemasukan/">Lihat semua <i
                                class="fas fa-chevron-right"></i></a>
                    </div>
                    <div>
                        <table class="table table-bordered table-sm">
                            <thead>
                                <tr>
                                    <th style="width: 10%; font-size: 12px;">No</th>
                                    <th style="width: 10%; font-size: 12px;">Keterang<an /th>
                                    <th style="width: 10%; font-size: 12px;">Jumlah</th>
                                    <th style="width: 10%; font-size: 12px;">Tanggal</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">Tidak ada pemasukan hari ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div class="col-xl-4 col-lg-5 mt-2">
                <div class="card">
                    <div class="card-header bg-primary d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-light" style="font-size: 14px;"> Total yang sudah hadir :
                            {{ $total_kehadiran }})
                        </h6>
                        <a class="m-0 float-right btn btn-danger btn-sm" href="/x100c/show/">Lihat semua <i
                                class="fas fa-chevron-right"></i></a>
                    </div>
                    <div>
                        <table class="table table-bordered table-sm">
                            <thead>
                                <tr>
                                    <th style="width: 10%; font-size: 12px;">No</th>
                                    <th style="width: 10%; font-size: 12px;">Nama</th>
                                    <th style="width: 10%; font-size: 12px;">Jam</th>
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center">Tidak ada yang hadir hari ini.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
