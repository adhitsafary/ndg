...
@section('konten')
    <div class="ml-5 mr-5 mb-5">
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h4>Kirim Pesan Promo Pembayaran Tanggal 25 Ramadhan</h4>
            </div>
            <div class="card-body">
                ...
                <form action="{{ route('promo_tgl25.create') }}" method="GET" class="mb-3">
                    <div class="row">
                ...
                <form action="{{ route('promo_tgl25.store') }}" method="POST">
                    @csrf
    ...
    <script>
        function updateMessage() {
            ...
            let message = "✨ *PENAWARAN SPESIAL UNTUK PELANGGAN SETIA!* 🎁💰\n\n";
            ...
            for (let option of select.selectedOptions) {
                ...
                message +=
                    "Net Digital Group menghadirkan *promo spesial* untuk Anda! Jangan lewatkan kesempatan mendapatkan *kupon hadiah langsung* dengan membayar tagihan internet *sebelum tanggal 25* di kantor kami! 🎉\n\n";
                ...
                message +=
                    "🎁 dan Dapatkan *Potongan pembayaran internet* dengan mengajak teman atau saudara untuk berlangganan WiFi! 🎁 \n\n";
                message += "Segera lunasi tagihan dan tukarkan kuponmu dengan hadiah spesial! 🎊🔥\n\n";
                message += "📍 *Datang dan bayar di kantor sekarang!* 🚀\n";
                message += "📍 *Lokasi:* [Klik di sini](https://maps.app.goo.gl/7GBV2Kgy1SM2rZGM8)\n\n";
