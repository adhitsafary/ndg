...
<div class="ml-5 mr-5 mb-5">
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('plg_of.create') }}" method="GET" class="mb-3">
                <div class="row">
            ...
            <form action="{{ route('plg_of.store') }}" method="POST">
                @csrf
...
<script>
    function updateMessage() {
        ...
        for (let option of select.selectedOptions) {
            ...
            let message = "🌙 *Promo Spesial Ramadhan untuk Pelanggan Setia!* 🌙\n\n";
            message += "✨ *Kabar Gembira!* ✨\n";
            message += `Halo Pelanggan yang terhormat *${nama}*,\n\n`;
