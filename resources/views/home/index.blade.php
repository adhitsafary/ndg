                            ...
                            <tbody>
                                @forelse($pemberitahuan as $item)
                                    <tr>
                                        ...
                                        <td style="font-size: 12px; font-weight: bold;">{{ $item->created_at }}</td>
                                    </tr>
                                @empty
                                    <tr>
                    ...
                    <div>
                        <table class="table table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="text-center" style="font-size: 12px; font-weight: bold;">
                                            Tidak ada
                            ...
                            <tbody>
                                @forelse($perbaikan_limited as $item)
                                    <tr>
                                        ...
                                        <td style="font-size: 12px; font-weight: bold;">{{ $item->alamat_plg }}</td>
                                        <td style="font-size: 12px; font-weight: bold;">{{ $item->created_at }}</td>
                                    </tr>
                                @empty
                                    <tr>
                            ...
                            <tbody>
                                @forelse($rekap_pengeluaran_limited as $item)
                                    <tr>
                                        <td class="text-center" style="font-size: 12px; font-weight: bold;">
                                            {{ $loop->iteration }}</td>
                                        <td style="font-size: 12px; font-weight: bold;">{{ $item->keterangan }}</td>
                                        <td style="font-size: 12px; font-weight: bold;">{{ $item->jumlah }}</td>
                                        <td style="font-size: 12px; font-weight: bold;">{{ $item->created_at }}</td>
                                    </tr>
                                @empty
                                    <tr>
...
<script>
    setTimeout(() => {
        window.location.href = "{{ url('/home/pemasangan/') }}";
