    ...
    <div class="mt-2 container text-center">
        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 g-3 justify-content-center">
            <?php foreach ($mergedResults as $data) : ?>
                <?php if ($data['tgl_tagih_plg'] >= 11 && $data['tgl_tagih_plg'] <= 20) : ?>
                    <div class="col mb-2">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <ul>
                                    <?php
                                    $pelangganIsolir = \App\Models\Pelanggan::where('tgl_tagih_plg', $data['tgl_tagih_plg'])
...
<script>
    setTimeout(() => {
        window.location.href = "{{ url('/home/isolir3') }}";
    }, 10000);
</script>
