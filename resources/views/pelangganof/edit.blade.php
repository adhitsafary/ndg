...
@section('konten')
    <div class="card m-5">
        ...
        <form id="editPelangganForm" action="{{ route('pelangganof.update', $pelangganof->id) }}" method="POST">
            ...
            <input type="text" name="id_plg" value="{{ $pelangganof->id_plg }}" class="form-control " readonly>
            ...
            <input type="text" name="alamat_plg" value="{{ $pelangganof->alamat_plg }}" class="form-control "
                id="alamat_plg">
            <div class="invalid-feedback" id="alamat_plgError">Field Alamat tidak boleh kosong.</div>

            <label for="" class="mt mt-3">No Telpon</label>
            <input type="text" name="no_telepon_plg" value="{{ $pelangganof->no_telepon_plg }}" class="form-control "
                id="no_telepon_plg">
            ...
            <input type="text" name="aktivasi_plg" value="{{ $pelangganof->aktivasi_plg }}" class="form-control "
                id="aktivasi_plg">
            ...
            <input type="text" name="tgl_tagih_plg" value="{{ $pelangganof->tgl_tagih_plg }}" class="form-control "
                id="aktivasi_plg">
            ...
            <input type="text" name="paket_plg" value="{{ $pelangganof->paket_plg }}" class="form-control "
                id="paket_plg">
            <div class="invalid-feedback" id="paket_plgError">Field Paket tidak boleh kosong.</div>

            <label for="" class="mt mt-3">Harga Paket</label>
            <input type="text" name="harga_paket" value="{{ $pelangganof->harga_paket }}" class="form-control "
                id="harga_paket">
            ...
            <input type="text" name="odp" value="{{ $pelangganof->odp }}" class="form-control " id="odp">
            ...
            <input type="text" name="latitude" value="{{ $pelangganof->latitude }}" class="form-control "
                id="latitude">
            <div class="invalid-feedback" id="latitudeError">Field Latitude tidak boleh kosong.</div>

            <label for="" class="mt mt-3">Longitude</label>
            <input type="text" name="longitude" value="{{ $pelangganof->longitude }}" class="form-control "
                id="longitude">
