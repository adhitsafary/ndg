...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap1000"
                    aria-expanded="true" aria-controls="collapseBootstrap1000">
                    <img src="<?php echo e(asset('asset/img/icon/kerja.png')); ?>" alt="Gambar Pelanggan"
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img src="<?php echo e(asset(Auth::check() && Auth::user()->foto ? Auth::user()->foto : 'asset/img/user/user.png')); ?>"
                                    alt="Foto Pengguna" style="max-width: 50px; max-height: 50px; border-radius: 50%;">
...
<?php /**PATH C:\xampp\htdocs\laravel\baru\2025\baru\dashboard2\resources\views/layout_login.blade.php ENDPATH**/ ?>