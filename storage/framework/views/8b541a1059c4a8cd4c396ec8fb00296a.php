<?php $__env->startSection('konten'); ?>
    <div class="container mt-4">
        ...
        <form id="pelangganForm" action="<?php echo e(route('pelanggan.store')); ?>" method="POST" class="font font-weight-bold" style="color: black">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\pelanggan\create.blade.php ENDPATH**/ ?>