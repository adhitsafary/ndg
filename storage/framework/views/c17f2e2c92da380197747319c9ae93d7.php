<?php $__env->startSection('konten'); ?>
    <div class="  pl-5 pr-5 mb-4">
        ...
        <div class="d-flex align-items-center justify-content-between mt-2">
            <form action="<?php echo e(route('pelanggan.isolir')); ?>" method="GET" class="form-inline d-flex" style="color: black;">
    ...
    ">
            ...
            <div class="col-md-3 text-right">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?php echo e(route('pelanggan.export_isolir', [
                            'format' => 'pdf',
        ...
        <div class="">
            ...
            <th class="mt-2">
                <form action="<?php echo e(route('pelanggan.isolir')); ?>" method="GET">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $pelanggan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td style="padding: 5px; font-size: 0.85em; text-align: center;">
                                ...
                                <span
                                    class="badge <?php echo e(strcasecmp($item->status_pembayaran, 'Sudah Bayar') === 0 ? 'bg-success' : 'bg-danger'); ?> text-white"
                                    style="font-size: 0.75em; padding: 2px;"><?php echo e($item->status_pembayaran); ?></span>
                            </td>

                            <!-- Tombol Status -->
                            <td style="padding: 5px; font-size: 0.85em; text-align: center;">
                                <?php if(auth()->user()->role === 'superadmin'): ?>
                                    <form action="<?php echo e(route('pelanggan.toggleStatus', $item->id)); ?>" method="POST"
                                        style="display: inline;">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="status"
                                            value="<?php echo e($item->status_pembayaran === 'Block' ? 'nonblock' : 'block'); ?>">
                                        <button type="submit" style="border: none; background: none; cursor: pointer;">
                                            <img src="<?php echo e(asset('asset/img/' . ($item->status_pembayaran === 'Block' ? 'off.png' : 'on.png'))); ?>"
                                                alt="<?php echo e($item->status_pembayaran === 'Block' ? 'Nonblock' : 'Block'); ?>"
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\baru\dashboard2\resources\views/pelanggan/isolir.blade.php ENDPATH**/ ?>