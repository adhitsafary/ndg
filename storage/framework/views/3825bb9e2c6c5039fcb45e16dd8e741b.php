<?php $__env->startSection('konten'); ?>
        ...
        <div class="row mb-3">
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="row text text-white font-weight-bold  mb-1">
                                    <div class="ml-2 mr-3">
                                        <img class="" height="50px" src="<?php echo e(asset('asset/img/icon/uang_cash.png')); ?>">
                                    </div>
                                    <div>
                                        <div>
                                            Pemasukan CASH - Pengeluaran
                                        </div>
                                        <div class=" h6 mb-0 mr-0 font-weight-bold text-white font-bold">Rp
                                            <?php echo e(number_format($totaljumlahsaldo, 0, ',', '.')); ?> || <?php echo e($totalUserHarian); ?>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="row text text-white font-weight-bold  mb-1">
                                    <div class="ml-2 mr-3">
                                        <img class="" height="50px" src="<?php echo e(asset('asset/img/icon/uang_karung.png')); ?>">
                                    </div>
                                    <div>
                                        <div>
                                            Total User yang
                                        ...
                                        <div class=" h6 mb-0 mr-0 font-weight-bold text-white font-bold">Rp
                                            <?php echo e(number_format($total_user_bayar , 0, ',', '.')); ?> || <?php echo e($total_jml_user); ?>
            ...
            <div class="col-xl-2 col-md-6 mb-3">
                <div class="card-hijau  h-70">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <a href="<?php echo e(route('pelanggan.redirect')); ?>">
                                <div class="col mr-2">
                                    <div class=" text text-white font-weight-bold  mb-1">Total Tagihan hari
                                        ini
                                    </div>
                                    <div class=" mb-0 font-weight-bold text text-white">Rp
                                        <?php echo e(number_format($totalTagihanHariIni, 0, ',', '.')); ?> ||
                                        <?php echo e($jumlahPelangganMembayarHariIni); ?>
            ...
            <div class="col-xl-2 col-md-6 mb-3">
                <div class="card-kuning  h-70">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <a href="<?php echo e(route('pelanggan.sudahbayar')); ?>">
                                <div class="col mr-2">
                                    <div class=" text text-white font-weight-bold  mb-1"> Tertagih Hari Ini
                                    </div>
                                    <div class=" mb-0 font-weight-bold text text-white">Rp
                                        Rp <?php echo e(number_format($totalPendapatanharian_semua, 0, ',', '.')); ?> ||
                                        <?php echo e($totalUserHarian_semua); ?>
            ...
            <div class="col-xl-2 col-md-6 mb-3">
                <div class="card-merah  h-70">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <a href="<?php echo e(route('pelanggan.belumbayar')); ?>">
                                <div class="col mr-2">
                                    <div class=" text text-white font-weight-bold  mb-1"> Sisa Tagihan Hari Ini
                                    </div>
                                    <div class=" mb-0 font-weight-bold text text-white">Rp
                                        Rp <?php echo e(number_format($totalTagihanTertagih, 0, ',', '.')); ?> ||
                                        <?php echo e($totalUserTertagih); ?>
                    ...
                    <div class="mt-3 ml-2 d-flex justify-content-between">
                        ...
                        <div class="bg-success py-3 d-flex flex-column align-items-start justify-content-center"
                            ...
                            <div class="text-white h6 mb-0 font-weight-bold pl-3">
                                Rp <?php echo e(number_format($totalTagihanHariIni, 0, ',', '.')); ?> <br> User :
                                <?php echo e($jumlahPelangganMembayarHariIni); ?>
                        ...
                        <div class="bg-warning py-3 d-flex flex-column align-items-start justify-content-center ml-2"
                            ...
                            <div class="text-white h6 mb-0 font-weight-bold pl-3">
                                Rp <?php echo e(number_format($totalPendapatanharian_semua, 0, ',', '.')); ?> <br> User :
                                <?php echo e($totalUserHarian_semua); ?>
                        ...
                        <div class="bg-danger py-3 d-flex flex-column align-items-start justify-content-center mr-2"
                            ...
                            <div class="text-white h6 mb-0 font-weight-bold pl-3">
                                Rp <?php echo e(number_format($totalTagihanTertagih, 0, ',', '.')); ?> <br> User :
                                <?php echo e($totalUserTertagih); ?>
                        ...
                        <div class="mt-3 ml-2 d-flex justify-content-between">
                            ...
                            <div class="bg-warning py-3 d-flex flex-column align-items-start justify-content-center"
                                ...
                                <div class="text-white h5 mb-0 font-weight-bold pl-3">
                                    <?php echo e(number_format($hasil_target)); ?>
                            ...
                            <div class="bg-danger py-3 d-flex flex-column align-items-start justify-content-center mr-2"
                                ...
                                <div class="text-white h5 mb-0 font-weight-bold pl-3">
                                    <?php echo e(number_format($sisa_target)); ?>
                            ...
                            <div class="bg-success py-3 d-flex flex-column align-items-start justify-content-center"
                                ...
                                <div class="text-white h5 mb-0 font-weight-bold pl-3">
                                    <?php echo e(number_format($jumlah_target)); ?>
            ...
            <script>
                ...
                const labels = <?php echo json_encode($labels, 15, 512) ?>; // Label untuk tanggal (1-30)
                const totalUsers = <?php echo json_encode($totalUsers, 15, 512) ?>; // Jumlah user per tanggal
                const totalPembayaran = <?php echo json_encode($totalPembayaran, 15, 512) ?>; // Total pembayaran per tanggal
                ...
                var totalTagihanHariIni = <?php echo json_encode($totalTagihanHariIni, 15, 512) ?>; // Total tagihan hari ini
                var totalPendapatanharian_semua = <?php echo json_encode($totalPendapatanharian_semua, 15, 512) ?>; // Total pendapatan harian semua
                ...
                //Target Marketing
                // Data untuk Pie Chart
                var sisa_target = <?php echo json_encode($sisa_target, 15, 512) ?>; // Total tagihan hari ini
                var jumlah_target = <?php echo json_encode($jumlah_target, 15, 512) ?>; // Total pendapatan harian semua
    ...
    <div class="running-text-container">
        <div class="running-text">
            <span>
                Sisa Tagihan Hari Ini: Rp <?php echo e(number_format($totalTagihanTertagih, 0, ',', '.')); ?> User:
                <?php echo e($totalUserTertagih); ?> ||
                Tagihan Hari Ini: Rp <?php echo e(number_format($totalTagihanHariIni, 0, ',', '.')); ?> User:
                <?php echo e($jumlahPelangganMembayarHariIni); ?> ||
                Tertagih: Rp <?php echo e(number_format($totalPendapatanharian_semua, 0, ',', '.')); ?> User:
                <?php echo e($totalUserHarian_semua); ?>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\baru\dashboard2\resources\views/index.blade.php ENDPATH**/ ?>