                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <div class=" h6 mb-0 mr-0 font-weight-bold text-white font-bold">Rp
                                    <?php echo e(number_format($totaljumlahsaldo, 0, ',', '.')); ?> || <?php echo e($totalUserHarian); ?></div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class=" mb-0 font-weight-bold text text-white">Rp
                                    <?php echo e(number_format($total_user_bayar, 0, ',', '.')); ?> || <?php echo e($total_jml_user); ?></div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <a href="<?php echo e(route('pelanggan.redirect')); ?>">
                                <div class="col mr-2">
                                    ...
                                    <div class=" mb-0 font-weight-bold text text-white">Rp
                                        <?php echo e(number_format($totalTagihanHariIni, 0, ',', '.')); ?> || <?php echo e($jumlahPelangganMembayarHariIni); ?></div>
                                    <!-- Menampilkan pendapatan dengan format rupiah -->
                                    <div class="mb-0 text-muted">
                                        <span class="text text-white font-weight-bold "></span>
                                        <span class="text text-white mr-2 font-weight-bold "><i
                        ...
                        <a href="<?php echo e(route('pelanggan.sudahbayar')); ?>">
                                <div class="col mr-2">
                                    ...
                                    Rp <?php echo e(number_format($totalPendapatanharian_semua, 0, ',', '.')); ?> ||
                                        <?php echo e($totalUserHarian_semua); ?></div>
                                    <!-- Menampilkan pendapatan dengan format rupiah -->
                                    <div class="mb-0 text-muted">
                                        <span class="text text-white font-weight-bold "></span>
                                        <span class="text text-white mr-2 font-weight-bold "><i
                            ...
                            <a href="<?php echo e(route('pelanggan.belumbayar')); ?>">
                                <div class="col mr-2">
                                    ...
                                    Rp <?php echo e(number_format($totalTagihanTertagih, 0, ',', '.')); ?> ||
                                        <?php echo e($totalUserTertagih); ?></div>
                                    <!-- Menampilkan pendapatan dengan format rupiah -->
                                    <div class="mb-0 text-muted">
                                        <span class="text text-white font-weight-bold "></span>
                                        <span class="text text-white mr-2 font-weight-bold "><i
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\superadmin\index.blade.php ENDPATH**/ ?>