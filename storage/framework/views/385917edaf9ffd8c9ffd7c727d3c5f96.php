<?php $__env->startSection('konten'); ?>
    <div class="  pl-5 pr-5 mb-4">
                ...
                <tbody>
                    <tr>
                        <td class="custom-cell info"
                            onclick="copyToClipboard('Total Sudah Bayar: <?php echo e($totalSudahBayar); ?> (Rp <?php echo e(number_format($totalPembayaranSudahBayar, 0, ',', '.')); ?>)')">
                            Rp <?php echo e(number_format($totalPembayaranSudahBayar, 0, ',', '.')); ?> User: <?php echo e($totalSudahBayar); ?>

                        </td>

                        <td class="custom-cell warning"
                            onclick="copyToClipboard('Total Belum Bayar: <?php echo e($totalBelumBayar); ?> (Rp <?php echo e(number_format($totalPembayaranBelumBayar, 0, ',', '.')); ?>)')">
                        ...
                        <td class="custom-cell primary-red"
                            onclick="copyToClipboard('Total Masuk: Rp <?php echo e(number_format($totalJumlahPembayaran, 0, ',', '.')); ?> || User: <?php echo e(number_format($totalPelangganBayar, 0, ',', '.')); ?>')">
                        ...
                        <td class="custom-cell primary-green"
                            onclick="copyToClipboard('Tersisa: Rp <?php echo e(number_format($sisaPembayaran, 0, ',', '.')); ?> || User: <?php echo e(number_format($sisaUser, 0, ',', '.')); ?>')">
        ...
        <div class="d-flex align-items-center justify-content-between mt-2">
            <form action="<?php echo e(route('pelanggan.reactivasi')); ?>" method="GET" class="form-inline d-flex" style="color: black;">
            ...
            <div class="col-md-3 text-right">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?php echo e(route('pelanggan.export', ['format' => 'pdf', 'tgl_tagih_plg' => request('tgl_tagih_plg')])); ?>"
                            class="dropdown-item">PDF</a>
                        <a href="<?php echo e(route('pelanggan.export', ['format' => 'excel', 'tgl_tagih_plg' => request('tgl_tagih_plg')])); ?>"
        ...
        <div class="">
            <th>
                <form action="<?php echo e(route('pelanggan.reactivasi')); ?>" method="GET">
            ...
            <table class="table table-bordered table-responsive " style="color: black;">
                <thead class="table table-danger " style="color: black;">
                    <tr class="font-weight-bold">
                        ...
                        <th>Aktivasi</th>
                        <th>
                            <form class="filterForm" method="GET" action="<?php echo e(route('pelanggan.reactivasi')); ?>">
                        ...
                        <th>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <!-- Form Filter -->
                                <div class="col-md-3 text-right">
                                    <form action="<?php echo e(route('pelanggan.reactivasi')); ?>" method="GET" class="form-inline"
                                        id="filterForm">
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\pelanggan\reactivasi.blade.php ENDPATH**/ ?>