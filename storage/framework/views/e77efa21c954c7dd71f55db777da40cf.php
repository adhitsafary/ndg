<?php $__env->startSection('konten'); ?>
    <div class="container mt-4">
        ...
        <form id="editPelangganForm" action="<?php echo e(route('pelanggan.update', $pelanggan->id)); ?>" method="POST">
            ...
            <input type="text" name="status_pembayaran" value="<?php echo e($pelanggan->status_pembayaran); ?>" class="form-control "
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\pelanggan\edit.blade.php ENDPATH**/ ?>