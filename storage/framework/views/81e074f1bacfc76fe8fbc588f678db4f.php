<?php $__env->startSection('konten'); ?>
    <div class="  pl-5 pr-5 mb-4">
        ...
        <div class="d-flex align-items-center justify-content-between mt-2">
            <form action="<?php echo e(route('pelanggan.unblock')); ?>" method="GET" class="form-inline d-flex"
                style="color: black;">
        ...
        <div class="">
            <th>
                <form action="<?php echo e(route('pelanggan.unblock')); ?>" method="GET">
            ...
            <table class="table table-bordered table-responsive " style="color: black;">
                <thead class="table table-danger " style="color: black;">
                    <tr class="font-weight-bold">
                        ...
                        <th>Aktivasi</th>
                        <th>
                            <form class="filterForm" method="GET" action="<?php echo e(route('pelanggan.unblock')); ?>">
                        ...
                        <th>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="col-md-3 text-right">
                                    <form action="<?php echo e(route('pelanggan.unblock')); ?>" method="GET" class="form-inline"
                                        id="filterForm">
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\pelanggan\unblock.blade.php ENDPATH**/ ?>