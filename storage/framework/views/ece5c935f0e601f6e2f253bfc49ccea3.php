...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo e(asset('template2/ui-colors.html')); ?>">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="img-profile rounded-circle" src="<?php echo e(asset('/template2/img/boy.png')); ?>" style="max-width: 60px">
                ...
                <div class="container-fluid" id="container-wrapper">
                    ...
                    <div class="text-center">
                        <img src="<?php echo e(asset('/template2/img/think.svg')); ?>" style="max-height: 90px">
...
<?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\layouts\master2.blade.php ENDPATH**/ ?>