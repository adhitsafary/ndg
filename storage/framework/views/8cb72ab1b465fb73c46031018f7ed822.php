        ...
        <div class="container  ">
            ...
            <div class="d-flex justify-content-between align-items-center p-3"
                ...
                <div class="p-3 text-center" style="background-color: #007bff; color: white; flex: 1; margin-right: 10px;">
                    ...
                    <div style="font-size: 1.5em;"><?php echo e(number_format($totalJumlahPembayaran)); ?></div>
                </div>

                <div class="p-3 text-center" style="background-color: #28a745; color: white; flex: 1;">
                    <strong>Jumlah Pelanggan:</strong>
                    <div style="font-size: 1.5em;"><?php echo e($totalPelanggan); ?></div>
                </div>
            </div>
        </div>

        <th class="mt-4 mb-4">
            <form action="<?php echo e(route('pembayaran.index')); ?>" method="GET" class="d-flex align-items-center">
                ...
                <div class="d-flex align-items-center mb-3">
                    ...
                    <input type="date" name="date_start" id="date_start" class="form-control me-2" value="<?php echo e($date_start); ?>">
                    <span class="mx-2">Tanggal Akhir</span>
                    <input type="date" name="date_end" id="date_end" class="form-control" value="<?php echo e($date_end); ?>">
                </div>
                ...
                <select name="paket_plg" id="paket_plg" class="form-select me-2 ml-2">
                    ...
                    <?php endfor; ?>
                    <option value="vcr" <?php echo e(request('paket_plg') == 'vcr' ? 'selected' : ''); ?>>vcr</option>
                </select>

                <select name="harga_paket" id="harga_paket" class="form-select me-2">
                    <option value="">Harga</option>
                    <?php $__currentLoopData = [50000, 75000, 100000, 105000, 115000, 120000, 125000, 150000, 165000, 175000, 205000, 250000, 265000, 305000, 750000]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $harga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($harga); ?>" <?php echo e(request('harga_paket') == $harga ? 'selected' : ''); ?>>
                            <?php echo e(number_format($harga, 0, ',', '.')); ?>

                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <option value="vcr" <?php echo e(request('harga_paket') == 'vcr' ? 'selected' : ''); ?>>vcr</option>
                </select>
                    ...
                    <div class="col-md-3 text-right">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                <a href="<?php echo e(route('pembayaran.export', [
                                    'format' => 'pdf',
        ...
        <table class="table table-bordered table-responsive" style="color: black;">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $pembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="">
                        <td style="padding: 2px;"><?php echo e(($pembayaran->currentPage() - 1) * $pembayaran->perPage() + $loop->iteration); ?></td>

                        <td style="padding: 2px;"><?php echo e($item->nama_plg); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->no_telepon_plg); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->alamat_plg); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->paket_plg); ?></td>
                        <!-- ambil bulan saja dan convert ke text misal bulan 09 jadi september -->
                        <td style="padding: 2px;"><?php echo e(\Carbon\Carbon::parse($item->tanggal_pembayaran)->format('F Y')); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->created_at); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->tgl_tagih_plg); ?></td>
                        <td style="padding: 2px;"><?php echo e(number_format($item->jumlah_pembayaran, 0, ',', '.')); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->metode_transaksi); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->untuk_pembayaran); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->keterangan_plg); ?></td>
                        <td style="padding: 2px;"><?php echo e($item->admin_name); ?></td>
                        <td style="display: none;"><?php echo e($item->id_plg); ?></td>
                        <td style="padding: 2px;">
                            <a href="<?php echo e(route('pembayaran.edit', $item->id)); ?>" class="btn btn-primary btn-sm">
                            <img src="<?php echo e(asset('asset/img/icon/edit.png')); ?>" style="height : 30px; width : 30px" alt="">
                            </a>
                        </td>
                        <td style="padding: 2px;">
                            <form action="<?php echo e(route('pembayaran.destroy', $item->id)); ?>" method="POST"
                                ...
                                <button
                                    ...
                                    <img src="<?php echo e(asset('asset/img/icon/delete.png')); ?>" style="height: 30px; width: 30px;" alt="Hapus" ></button>
                            </form>
                        </td>
                        <td style="padding: 2px;">
                            <button class="btn btn-info btn-sm"
                                onclick="printPayment(<?php echo e($no + 1); ?>, '<?php echo e($item->nama_plg); ?>')">
                            <img src="<?php echo e(asset('asset/img/icon/printer.png')); ?>" style="height : 30px; width 30px; " alt="">
                            </button>
                        </td>
                    </tr>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\pembayaran\index.blade.php ENDPATH**/ ?>