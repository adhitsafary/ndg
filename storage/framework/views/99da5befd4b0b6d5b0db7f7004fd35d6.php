    ...
    <div class=" p-5 ">
        ...
        <div class="container mt-4 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('pembayaran.pembayaran_hp')); ?>" method="GET">
                        <!-- Filter Tambahan -->
                        <div class="row">
                            <div class="mb-3 mr-2">
                                ...
                                <select name="tgl_tagih_plg" id="tgl_tagih_plg" class="form-select">
                                    ...
                                    <?php for($i = 1; $i <= 33; $i++): ?>
                                        <option value="<?php echo e($i); ?>"
                                            <?php echo e(request('tgl_tagih_plg') == $i ? 'selected' : ''); ?>><?php echo e($i); ?>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="paket_plg" id="paket_plg" class="form-select">
                                    ...
                                    <?php for($i = 1; $i <= 7; $i++): ?>
                                        <option value="<?php echo e($i); ?>"
                                            <?php echo e(request('paket_plg') == $i ? 'selected' : ''); ?>><?php echo e($i); ?></option>
                                    <?php endfor; ?>
                                    <option value="vcr" <?php echo e(request('paket_plg') == 'vcr' ? 'selected' : ''); ?>>vcr
                                    </option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="mb-3 mr-2">
                                ...
                                <select name="harga_paket" id="harga_paket" class="form-select">
                                    ...
                                    <?php $__currentLoopData = [50000, 75000, 100000, 105000, 115000, 120000, 125000, 150000, 165000, 175000, 205000, 250000, 265000, 305000, 750000]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $harga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($harga); ?>"
                                            <?php echo e(request('harga_paket') == $harga ? 'selected' : ''); ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="untuk_pembayaran" id="untuk_pembayaran" class="form-select">
                                    ...
                                    <option value="piutang"
                                        <?php echo e(request('untuk_pembayaran') == 'piutang' ? 'selected' : ''); ?>>
                                        Piutang</option>
                                    <option value="tagihan"
                                        <?php echo e(request('untuk_pembayaran') == 'tagihan' ? 'selected' : ''); ?>>
                                        Tagihan</option>
                                    <option value="psb" <?php echo e(request('untuk_pembayaran') == 'psb' ? 'selected' : ''); ?>>PSB
                                    </option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="search" id="search" class="form-control"
                                value="<?php echo e(request('search')); ?>" placeholder="Masukkan kata kunci">
                        </div>
        ...
        <div class="container mt-4">
            <?php $__empty_1 = true; $__currentLoopData = $pembayaran; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $no => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="card mb-3 shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <strong><?php echo e($item->nama_plg); ?></strong>
                    </div>
                    <div class="card-body">
                        <p class="mb-1"><strong>No Telepon:</strong> <?php echo e($item->no_telepon_plg); ?></p>
                        <p class="mb-1"><strong>Alamat:</strong> <?php echo e($item->alamat_plg); ?></p>
                        <p class="mb-1"><strong>Paket:</strong> <?php echo e($item->paket_plg); ?></p>
                        <p class="mb-1"><strong>Bulan Bayar:</strong>
                            <?php echo e(\Carbon\Carbon::parse($item->tanggal_pembayaran)->format('F Y')); ?></p>
                        <p class="mb-1"><strong>Tanggal Pembayaran:</strong> <?php echo e($item->created_at); ?></p>
                        <p class="mb-1"><strong>Tanggal Tagih:</strong> <?php echo e($item->tgl_tagih_plg); ?></p>
                        <p class="mb-1"><strong>Jumlah Pembayaran:</strong>
                            Rp<?php echo e(number_format($item->jumlah_pembayaran, 0, ',', '.')); ?></p>
                        <p class="mb-1"><strong>Metode Pembayaran:</strong> <?php echo e($item->metode_transaksi); ?></p>
                        <p class="mb-1"><strong>Pembayaran:</strong> <?php echo e($item->untuk_pembayaran); ?></p>
                        <p class="mb-1"><strong>Keterangan:</strong> <?php echo e($item->keterangan_plg); ?></p>
                        <p class="mb-1"><strong>Admin:</strong> <?php echo e($item->admin_name); ?></p>
                    </div>
                    <div class="card-footer d-flex justify-content-between">
                        <a href="<?php echo e(route('pembayaran.edit', $item->id)); ?>" class="btn btn-primary btn-sm">
                            <img src="<?php echo e(asset('asset/img/icon/edit.png')); ?>" alt="Edit"
                        ...
                        <form action="<?php echo e(route('pembayaran.destroy', $item->id)); ?>" method="POST"
                            ...
                            <button onclick="return confirm('Yakin ingin menghapus data ini?')"
                                ...
                                <img src="<?php echo e(asset('asset/img/icon/delete.png')); ?>" alt="Hapus"
                                    style="height: 20px; width: 20px;">
                            </button>
                        </form>
                        <button class="btn btn-info btn-sm"
                            onclick="printPayment(<?php echo e($no + 1); ?>, '<?php echo e($item->nama_plg); ?>')">
                            <img src="<?php echo e(asset('asset/img/icon/printer.png')); ?>" alt="Print"
                                style="height: 20px; width: 20px;">
                        </button>
                    </div>
                </div>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\pembayaran\pembayaran_hp.blade.php ENDPATH**/ ?>