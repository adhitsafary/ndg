<?php $__env->startSection('konten'); ?>
    <div class="container mt-4">
        ...
        <form action="<?php echo e(route('pengeluaran.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <!-- Input jumlah -->
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\pengeluaran\create.blade.php ENDPATH**/ ?>