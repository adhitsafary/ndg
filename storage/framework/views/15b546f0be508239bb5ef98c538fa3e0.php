<?php $__env->startSection('konten'); ?>
    <div class="container mb-4">
        ...
        <form action="<?php echo e(route('psb.store')); ?>" method="POST" class="font font-weight-bold" style="color: black">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\perbaikan\create_psb.blade.php ENDPATH**/ ?>