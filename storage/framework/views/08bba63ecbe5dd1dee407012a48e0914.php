        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/masuk/admin">
                <div class="sidebar-brand-icon">
                    <img src="<?php echo e(asset('template2/img/logo/logo2.png')); ?>">
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseBootstrap" class="collapse" aria-labelledby="collapseBootstrap1000"
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?php echo e(Auth::check() && Auth::user()->foto ? asset('storage/' . Auth::user()->foto) : asset('/template2/img/boy.png')); ?>"
...
<?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\layoutindex.blade.php ENDPATH**/ ?>