...
<head>
    ...
    <link href="<?php echo e(asset('asset/img/logo.png')); ?>" rel="icon">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/pembayaran/mudah" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/bayar_baru.png')); ?>" alt="Gambar Pelanggan"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap"
                    ...
                    <img src="<?php echo e(asset('asset/img/pelanggan.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/man.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
                ...
                <div id="collapseBootstrap17" class="collapse" aria-labelledby="headingBootstrap17"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded  font-weight-bold" style="color: black">
                        <a class="collapse-item" href="<?php echo e(route('karyawan.index')); ?>">Data Karyawan</a>
                        <a class="collapse-item" href="<?php echo e(route('karyawan.create')); ?>">Tambah Data Karyawan</a>
                        <a class="collapse-item" href="<?php echo e(route('kasbon.index')); ?>">Data kasbon</a>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/users.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
                ...
                <div id="collapseBootstrap100" class="collapse" aria-labelledby="headingBootstrap100"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded  font-weight-bold" style="color: black">
                        <a class="collapse-item" href="<?php echo e(route('users.index')); ?>">Data Admin Login</a>
                        <a class="collapse-item" href="<?php echo e(route('users.create')); ?>">Tambah Admin Login</a>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/baru.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/perbaikan.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
                ...
                <div id="collapseBootstrap1" class="collapse" aria-labelledby="headingBootstrap1"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded font-weight-bold" style="color: black">
                        ...
                        <a class="collapse-item" href="<?php echo e(route('perbaikan.create')); ?>">Buat PSB dan PERBAIKAN</a>
                        <a class="collapse-item" href="<?php echo e(route('psb.create')); ?>">Buat PSB dan Perbaikan Costume</a>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/icon/absen.png')); ?>" alt="Gambar Pelanggan"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/pengeluaran.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePage"
                    ...
                    <img src="<?php echo e(asset('asset/img/pembayaran.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    data-target="#collapseBootstrap17" aria-expanded="true" aria-controls="collapseBootstrap17">
                    <img src="<?php echo e(asset('asset/img/update.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/target.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/wa.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/folder.png')); ?>" alt="Gambar Pelanggan"
                        style="width: 30px; height: auto; margin-left: 10px;" class="mr-2">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse"
                    ...
                    <img src="<?php echo e(asset('asset/img/pemberitahuan.png')); ?>" alt="Gambar Pelanggan"
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img src="<?php echo e(asset(Auth::check() && Auth::user()->foto ? Auth::user()->foto : 'asset/img/user/user.png')); ?>"
                                    alt="Foto Pengguna"
...
<?php /**PATH C:\xampp\htdocs\laravel\baru\2025\dashboard2\resources\views\superadmin\layout_superadmin.blade.php ENDPATH**/ ?>